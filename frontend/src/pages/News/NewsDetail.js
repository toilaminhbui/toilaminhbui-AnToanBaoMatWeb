...
export default function NewsDetail(props) {
    ...
    const { arrBinhLuan, arrTinTuc, detailTinTuc, detailBinhLuan } =
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            if (!detailBinhLuan.maComment && !!values.comment !== "") {
                ...
                dispatch(
                    capNhatBinhLuanAction(detailBinhLuan.maComment, formData)
                );
                dispatch(layDanhSachBinhLuanAction(id));
                dispatch({
                        ...
                        <div className="mb-5">
                            <div className="d-flex justify-between p-3">
                                <div className="d-flex">
                                    <p className="text-danger rounded-full border  border-indigo-700 p-2">
                                        {detailTinTuc.tacGia}
                                    </p>
                                    <p className="ml-3 p-2">
                                        {detailTinTuc.theLoai}
                                    </p>
                                </div>

                                <p className="text-gray-400 p-2">
                                    {dayjs(detailTinTuc.created_at).format(
                                        "DD-MM-YYYY"
                                    )}
                                </p>
                            </div>
